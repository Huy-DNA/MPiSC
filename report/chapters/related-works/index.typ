...
#figure(
  kind: "table",
  supplement: "Table",
  caption: [Characteristic summary of existing shared memory MPSC queues. The cell marked with (\*) indicates that our evaluation contradicts with the author's claims],
  table(
    columns: (2.5fr, 1fr, 1fr, 1fr, 1fr),
    table.header([*MPSC queues*], [*LTQueue*], [*DQueue*], [*WRLQueue*], [*Jiffy*]),
    [ABA solution],
