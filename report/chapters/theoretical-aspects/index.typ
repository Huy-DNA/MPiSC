...
#proof[
  ...
  - For an dequeuer's read-front, $r$ must enter @line-spsc-d-readFront-resync-last because `First_buf = Tail_buf`, due to from the dequeuer's point of view, `First_buf = First` and `Last_buf <= Last`. Similarly, $r$ must execute @line-spsc-d-readFront-empty and return `false`.
