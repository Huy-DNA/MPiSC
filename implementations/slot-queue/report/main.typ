...
Each enqueue will have a local SPSC as in LTQueue @ltqueue that supports `dequeue`, `enqueue` and `readFront`. There's a global queue whose entry stores the minimum timestamp of the corresponding enqueuer's local SPSC.
