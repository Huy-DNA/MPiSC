...
public:
  ...
  UnboundedSlotQueue(const UnboundedSlotQueue &) = delete;
  UnboundedSlotQueue &operator=(const UnboundedSlotQueue &) = delete;

  UnboundedSlotQueue(UnboundedSlotQueue &&other) noexcept
