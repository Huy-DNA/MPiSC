...
int main(int argc, char **argv) {
  ...
  if (run_micro) {
    ...
    slotqueueV2a_single_one_queue_microbenchmark(1000, 5);
    slotqueueV2b_single_one_queue_microbenchmark(1000, 5);
    slotqueueV2bc_single_one_queue_microbenchmark(1000, 5);
    slotqueueV2c_single_one_queue_microbenchmark(1000, 5);
